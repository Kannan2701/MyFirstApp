            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-text">
                        ...
                        <img src="<?php echo base_url(); ?>assets/img/about-signature.png" alt="">
                        <div class="at-author">
                            <h4>Lettie Chavez</h4>
    ...
    <section class="gym-award spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <img src="<?php echo base_url(); ?>assets/img/award.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="banner-section set-bg" data-setbg="<?php echo base_url(); ?>assets/img/banner-bg.jpg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    <img src="<?php echo base_url(); ?>assets/img/banner-person.png" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="<?php echo base_url(); ?>assets/img/trainer/about-trainer-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="<?php echo base_url(); ?>assets/img/trainer/about-trainer-2.jpg" alt="">
                        <div class="trainer-text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="<?php echo base_url(); ?>assets/img/trainer/about-trainer-3.jpg" alt="">
                        <div class="trainer-text">
                            <h5>Walter Wagner</h5>
