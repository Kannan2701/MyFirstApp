    ...
    <div class="map">
        ...
        <img src="<?php echo base_url(); ?>assets/img/icon/location.png" alt="">
    </div>
    <!-- Map Section End -->
                ...
                <div class="col-lg-4">
                    <div class="contact-info">
                        ...
                        <div class="contact-address">
                            <div class="ca-widget">
                                <div class="cw-icon">
                                    <img src="<?php echo base_url(); ?>assets/img/icon/icon-1.png" alt="">
                                </div>
                                <div class="cw-text">
                                    <h5>Our Location</h5>
                            ...
                            <div class="ca-widget">
                                <div class="cw-icon">
                                    <img src="<?php echo base_url(); ?>assets/img/icon/icon-2.png" alt="">
                                </div>
                                <div class="cw-text">
                                    <h5>Phone:</h5>
                                    <p>+65 11.188.888</p>
                            ...
                            <div class="ca-widget">
                                <div class="cw-icon">
                                    <img src="<?php echo base_url(); ?>assets/img/icon/icon-3.png" alt="">
                                </div>
                                <div class="cw-text">
                                    <h5>Mail</h5>
