    ...
    <section class="about-section spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-pic">
                        <img src="<?php echo base_url(); ?>assets/img/about-pic.jpg" alt="">
                        <a href="https://www.youtube.com/watch?v=SlPhMPnQ58k" class="play-btn video-popup">
                            <img src="<?php echo base_url(); ?>assets/img/play.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="services-pic">
                        <img src="<?php echo base_url(); ?>assets/img/services/service-pic.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="services-item bg-gray">
                                    <img src="<?php echo base_url(); ?>assets/img/services/service-icon-1.png" alt="">
                                    <h4>Strategies</h4>
                                    <p>Aenean massa. Cum sociis Theme et natoque penatibus et magnis dis part urient
                                        montes.</p>
                                </div>
                                <div class="services-item bg-gray pd-b">
                                    <img src="<?php echo base_url(); ?>assets/img/services/service-icon-3.png" alt="">
                                    <h4>Workout</h4>
                                    <p>Aenean massa. Cum sociis Theme et natoque penatibus et magnis dis part urient
                                        montes.</p>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="services-item">
                                    <img src="<?php echo base_url(); ?>assets/img/services/service-icon-2.png" alt="">
                                    <h4>Yoga</h4>
                                    <p>Aenean massa. Cum sociis Theme et natoque penatibus et magnis dis part urient
                                        montes.</p>
                                </div>
                                <div class="services-item pd-b">
                                    <img src="<?php echo base_url(); ?>assets/img/services/service-icon-4.png" alt="">
                                    <h4>Weight Loss</h4>
                                    <p>Aenean massa. Cum sociis Theme et natoque penatibus et magnis dis part urient
                                        montes.</p>
                                </div>
    ...
    <section class="classes-section spad">
        <div class="container">
            ...
            <div class="row classes-slider owl-carousel">
                <div class="col-lg-4">
                    <div class="single-class-item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/classes/classes-1.jpg">
                        <div class="si-text">
                            <h4>Yoga</h4>
                            <span><i class="fa fa-user"></i> Ryan Knight</span>
                        </div>
                    </div>
                    <div class="single-class-item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/classes/classes-4.jpg">
                        <div class="si-text">
                            <h4>Karate</h4>
                ...
                <div class="col-lg-4">
                    <div class="single-class-item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/classes/classes-2.jpg">
                        <div class="si-text">
                            <h4>Running</h4>
                            <span><i class="fa fa-user"></i> Randy Rivera</span>
                        </div>
                    </div>
                    <div class="single-class-item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/classes/classes-5.jpg">
                        <div class="si-text">
                            <h4>Dance</h4>
                ...
                <div class="col-lg-4">
                    <div class="single-class-item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/classes/classes-3.jpg">
                        <div class="si-text">
                            <h4>Personal Training</h4>
                            <span><i class="fa fa-user"></i> Cole Robertson</span>
                        </div>
                    </div>
                    <div class="single-class-item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/classes/classes-6.jpg">
                        <div class="si-text">
                            <h4>Weight Loss</h4>
                ...
                <div class="col-lg-4">
                    <div class="single-class-item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/classes/classes-7.jpg">
                        <div class="si-text">
                            <h4>Personal Training</h4>
                            <span><i class="fa fa-user"></i> Cole Robertson</span>
                        </div>
                    </div>
                    <div class="single-class-item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/classes/classes-8.jpg">
                        <div class="si-text">
                            <h4>Weight Loss</h4>
                            <span><i class="fa fa-user"></i> Ryan Scott</span>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="<?php echo base_url(); ?>assets/img/trainer/trainer-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="<?php echo base_url(); ?>assets/img/trainer/trainer-2.jpg" alt="">
                        <div class="trainer-text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer-item">
                        <img src="<?php echo base_url(); ?>assets/img/trainer/trainer-3.jpg" alt="">
                        <div class="trainer-text">
                            <h5>Walter Wagner</h5>
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="testimonial-slider owl-carousel">
                        <div class="testimonial-item">
                            ...
                            <div class="ti-pic">
                                <img src="<?php echo base_url(); ?>assets/img/testimonial/testimonial-1.jpg" alt="">
                                <div class="quote">
                                    <img src="<?php echo base_url(); ?>assets/img/testimonial/quote-left.png" alt="">
                                </div>
                            </div>
                            <div class="ti-author">
    ...
    <section class="banner-section set-bg" data-setbg="<?php echo base_url(); ?>assets/img/banner-bg.jpg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    <<?php echo base_url(); ?>assets/img src="img/banner-person.png" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="register-pic">
                        <img src="<?php echo base_url(); ?>assets/img/register-pic.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="footer-banner">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <div class="footer-banner-item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/footer-banner/footer-banner-1.jpg">
                ...
                <div class="col-lg-6">
                    <div class="footer-banner-item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/footer-banner/footer-banner-2.jpg">
